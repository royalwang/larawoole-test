                ...
                <div class="panel panel-default">
                    <div class="panel-heading">{{ trans('view.admin.equip.title') }}
                        <a href="{{ route('admin.equip.create') }}" style="float: right;"
                           class="btn btn-info btn-sm" onclick="$('.spinner').fadeIn(50);">{{ trans('view.admin.public.create') .' '. trans('view.admin.equip.title') }}</a>
                    </div>
                        ...
                        <table class="table">
                            ...
                            @foreach($equips as $equip)
                                ...
                                @switch($equip->status)
                                    ...
                                    <td>
                                        <a class="btn btn-warning btn-sm" href="{{ route('admin.equip.edit', ['id' => $equip->id]) }}" onclick="$('.spinner').fadeIn(50);">{{ trans('view.admin.public.edit') }}</a>
