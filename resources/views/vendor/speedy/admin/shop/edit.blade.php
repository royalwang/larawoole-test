        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <form method="post" action="{{ isset($shop) ? route('admin.shop.update', ['id' => $shop->id]) :  route('admin.shop.store') }}">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="establish_time" class="form-control" placeholder="{{ trans('view.admin.shop.establish_time') }}" value="{{ isset($shop) ? $shop->establish_time : '' }}">
                            </div>
                            <div class="form-group">
