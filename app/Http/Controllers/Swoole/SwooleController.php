<?php
    ...
    class SwooleController extends Controller
    {
        ...
        public function onReceive( $serv = '' , $fd = '' , $from_id = '' , $data = '' )
        {
            ...
            $data = '$0018529001811002\r';//查询价格
            //$data = '$0037539001805001,135487390872883290\r';//创建订单
            //$data = '$0034569001805001,681811082215259\r';//提交支付
            //$data = '$0034549001805001,651811082302511\r';//打印小票成功
            ...
            //$this->pay_code = '134845721909664566';
            //心跳包不打印日志
