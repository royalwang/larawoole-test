 ...
 * Generated for Laravel 5.6.21 on 2018-05-09 06:21:32.
 *
...
namespace Hanson\Speedy {
    ...
    class SpeedyFacade
    {
        ...
        public static function getInstance()
        {
            return \Hanson\Speedy\Speedy::getInstance();
        }
         ...
         * @static
         */
        public static function getModelInstance($key)
        {
            return \Hanson\Speedy\Speedy::getModelInstance($key);
        }
         ...
         * @static
         */
        public static function getDefaultNamespace($key)
        {
            return \Hanson\Speedy\Speedy::getDefaultNamespace($key);
        }
        ...
        {
            return \Hanson\Speedy\Speedy::getMenus();
        }
        ...
        {
            return \Hanson\Speedy\Speedy::getKeyFromUrl($url);
        }
...
namespace {
    ...
    class Speedy extends \Hanson\Speedy\SpeedyFacade
    {
    }
